...
# **accountCartList**
```swift
    open class func accountCartList(storeUrl: String? = nil, storeKey: String? = nil, requestFromDate: String? = nil, requestToDate: String? = nil, customLabel: String? = nil, params: String? = nil, exclude: String? = nil, completion: @escaping (_ data: AccountCartList200Response?, _ error: Error?) -> Void)
```
...
let americommerceAppId = "americommerceAppId_example" // String | Americommerce App ID (optional)
let americommerceAppSecret = "americommerceAppSecret_example" // String | Americommerce App Secret (optional)
let americommerceAccessToken = "americommerceAccessToken_example" // String | Americommerce Access Token (optional)
let americommerceRefreshToken = "americommerceRefreshToken_example" // String | Americommerce Refresh Token (optional)
...
let shopifyClientId = "shopifyClientId_example" // String | Shopify Client ID (optional)
...
let miraklApiKey = "miraklApiKey_example" // String | Mirakl API Key (optional)
...
let nopcommerceToken = "nopcommerceToken_example" // String | Access token authorizing the app to access resources on behalf of a user (optional)
let nopcommerceSecret = "nopcommerceSecret_example" // String | nopCommerce webhook signing secret generated by the Api2Cart.Connector plugin. Optional when connecting a store, but required to receive webhooks from it. (optional)
...
let walmartRefreshToken = "walmartRefreshToken_example" // String | Walmart refresh token received by a Solution Provider application through the Walmart App Store authorization. When it is set, walmart_client_id and walmart_client_secret are the credentials of that application, not of the seller. Must be used together with walmart_seller_id and is supported only for walmart_region = 'us' (optional)
let walmartSellerId = "walmartSellerId_example" // String | Walmart seller id the refresh token was issued for, sent as the WM_PARTNER.ID header. Must be used together with walmart_refresh_token and is supported only for walmart_region = 'us' (optional)
...
let jumpsellerClientId = "jumpsellerClientId_example" // String | Jumpseller OAuth2 Client ID (optional)
let jumpsellerClientSecret = "jumpsellerClientSecret_example" // String | Jumpseller OAuth2 Client Secret (optional)
let jumpsellerRefreshToken = "jumpsellerRefreshToken_example" // String | Jumpseller OAuth2 refresh token (optional)
let jumpsellerLogin = "jumpsellerLogin_example" // String | Jumpseller API login (optional)
let jumpsellerAuthtoken = "jumpsellerAuthtoken_example" // String | Jumpseller API auth token (optional)
...
let scapiClientId = "scapiClientId_example" // String | Salesforce Commerce API Client ID (optional)
let scapiClientSecret = "scapiClientSecret_example" // String | Salesforce Commerce API Client Secret (optional)
let scapiOrganizationId = "scapiOrganizationId_example" // String | Salesforce Commerce Organization ID (optional)
let scapiShortCode = "scapiShortCode_example" // String | Salesforce Commerce Short Code (optional)
let scapiScopes = "scapiScopes_example" // String | Salesforce Commerce API Scopes (optional)
