...
public struct CatalogPriceRule: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(id: String? = nil, gid: String? = nil, type: String? = nil, name: String? = nil, description: String? = nil, shortDescription: String? = nil, avail: Bool? = nil, actions: [CatalogPriceRuleAction]? = nil, createdTime: A2CDateTime? = nil, dateStart: A2CDateTime? = nil, dateEnd: A2CDateTime? = nil, usageCount: Double? = nil, conditions: [CouponCondition]? = nil, usesPerOrderLimit: Int? = nil, additionalFields: JSONValue? = nil, customFields: JSONValue? = nil) {
        self.id = id
        self.gid = gid
        self.type = type
        self.name = name
