...
public struct OrderItem: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(productId: String? = nil, orderProductId: String? = nil, model: String? = nil, name: String? = nil, price: Double? = nil, priceIncTax: Double? = nil, quantity: Double? = nil, discountAmount: Double? = nil, totalPrice: Double? = nil, taxPercent: Double? = nil, taxValue: Double? = nil, taxValueAfterDiscount: Double? = nil, options: [OrderItemOption]? = nil, variantId: String? = nil, weightUnit: String? = nil, weight: Double? = nil, barcode: String? = nil, parentOrderProductId: String? = nil, additionalFields: JSONValue? = nil, customFields: JSONValue? = nil) {
