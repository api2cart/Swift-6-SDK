...
public struct ProductPriceUpdate: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(productId: String? = nil, groupPrices: [ProductPriceUpdateGroupPricesInner]? = nil, idempotencyKey: String? = nil) {
