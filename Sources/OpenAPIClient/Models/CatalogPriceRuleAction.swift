...
public struct CatalogPriceRuleAction: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(scope: String? = nil, applyTo: String? = nil, type: String? = nil, quantity: Double? = nil, value: Double? = nil, currencyCode: String? = nil, includeTax: Bool? = nil, conditions: [CouponCondition]? = nil, additionalFields: JSONValue? = nil, customFields: JSONValue? = nil) {
        self.scope = scope
