...
public struct BatchJobResult: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(jobId: Int? = nil, jobName: String? = nil, itemsProcessed: Int? = nil, itemsSucceed: Int? = nil, items: [BatchJobResultItem]? = nil, additionalFields: JSONValue? = nil, customFields: JSONValue? = nil) {
        self.jobId = jobId
