...
public struct OrderInfo200Response: Sendable, Codable, JSONEncodable, Hashable {

    public var returnCode: Int?
    public var returnMessage: String?
    public var result: Order?

    public init(returnCode: Int? = nil, returnMessage: String? = nil, result: Order? = nil) {
