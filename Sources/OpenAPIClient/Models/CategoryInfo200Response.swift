...
public struct CategoryInfo200Response: Sendable, Codable, JSONEncodable, Hashable {

    public var returnCode: Int?
    public var returnMessage: String?
    public var result: Category?

    public init(returnCode: Int? = nil, returnMessage: String? = nil, result: Category? = nil) {
