...
public struct OrderCalculateShippingRate: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(code: String? = nil, name: String? = nil, price: Double? = nil, priceIncTax: Double? = nil, tax: Double? = nil, taxRate: Double? = nil, additionalFields: JSONValue? = nil, customFields: JSONValue? = nil) {
        self.code = code
        self.name = name
        self.price = price
