...
public struct OrderPreestimateShipping: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(methodCode: String? = nil, methodName: String? = nil, carrierCode: String? = nil, carrierName: String? = nil, description: String? = nil, price: Double? = nil, priceIncTax: Double? = nil, deliveryTime: String? = nil, additionalFields: JSONValue? = nil, customFields: JSONValue? = nil) {
