...
public struct ResponseTaxClassInfoResult: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(id: String? = nil, name: String? = nil, avail: Bool? = nil, tax: Double? = nil, taxType: Int? = nil, createdAt: A2CDateTime? = nil, modifiedAt: A2CDateTime? = nil, taxRates: [TaxClassRate]? = nil, additionalFields: JSONValue? = nil, customFields: JSONValue? = nil) {
        self.id = id
        self.name = name
        self.avail = avail
        self.tax = tax
