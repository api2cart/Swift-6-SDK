...
public struct ProductInfo200Response: Sendable, Codable, JSONEncodable, Hashable {

    public var returnCode: Int?
    public var returnMessage: String?
    public var result: Product?

    public init(returnCode: Int? = nil, returnMessage: String? = nil, result: Product? = nil) {
