...
public struct CartInfo200Response: Sendable, Codable, JSONEncodable, Hashable {

    public var returnCode: Int?
    public var returnMessage: String?
    public var result: Cart?

    public init(returnCode: Int? = nil, returnMessage: String? = nil, result: Cart? = nil) {
