...
public struct AnalyticsPeriod: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(dateFrom: String? = nil, dateTo: String? = nil, additionalFields: JSONValue? = nil, customFields: JSONValue? = nil) {
