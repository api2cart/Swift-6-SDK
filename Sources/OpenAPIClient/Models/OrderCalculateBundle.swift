...
public struct OrderCalculateBundle: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(productId: String? = nil, sku: String? = nil, name: String? = nil, quantity: Int? = nil, price: Double? = nil, priceIncTax: Double? = nil, taxRate: Double? = nil, unitDiscount: Double? = nil, weight: Double? = nil, weightUnit: String? = nil, barcode: String? = nil, variantId: String? = nil, options: [OrderItemOption]? = nil, additionalFields: JSONValue? = nil, customFields: JSONValue? = nil) {
