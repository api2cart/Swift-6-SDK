...
public struct Discount: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(id: String? = nil, name: String? = nil, modifierType: String? = nil, value: Double? = nil, fromTime: String? = nil, toTime: String? = nil, customerGroupIds: String? = nil, sortOrder: Int? = nil, additionalFields: JSONValue? = nil, customFields: JSONValue? = nil) {
        self.id = id
        self.name = name
