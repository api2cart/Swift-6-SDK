...
public struct OrderStatusRefundItem: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(productId: String? = nil, variantId: String? = nil, orderProductId: String? = nil, qty: Double? = nil, refund: Double? = nil, additionalFields: JSONValue? = nil, customFields: JSONValue? = nil) {
