...
public struct ResponseBatchJobResult: Sendable, Codable, JSONEncodable, Hashable {

    public var returnCode: Int?
    public var returnMessage: String?
    public var result: BatchJobResult?
    public var additionalFields: JSONValue?
    public var customFields: JSONValue?

    public init(returnCode: Int? = nil, returnMessage: String? = nil, result: BatchJobResult? = nil, additionalFields: JSONValue? = nil, customFields: JSONValue? = nil) {
