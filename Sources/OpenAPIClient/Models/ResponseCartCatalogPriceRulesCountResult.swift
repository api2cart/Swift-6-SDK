...
public struct ResponseCartCatalogPriceRulesCountResult: Sendable, Codable, JSONEncodable, Hashable {

    public var catalogPriceRulesCount: Int?
    public var additionalFields: JSONValue?
    public var customFields: JSONValue?

    public init(catalogPriceRulesCount: Int? = nil, additionalFields: JSONValue? = nil, customFields: JSONValue? = nil) {
