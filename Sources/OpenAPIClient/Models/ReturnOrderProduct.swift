...
public struct ReturnOrderProduct: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(productId: String? = nil, orderProductId: String? = nil, sku: String? = nil, name: String? = nil, quantity: Int? = nil, reason: ReturnReason? = nil, action: ReturnAction? = nil, condition: String? = nil, customerComment: String? = nil, additionalFields: JSONValue? = nil, customFields: JSONValue? = nil) {
