...
public struct CartConfigUpdate: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(dbTablesPrefix: String? = nil, customFields: JSONValue? = nil, storeId: String? = nil, userAgent: String? = nil) {
