...
public struct ProductAdvancedPrice: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(id: String? = nil, value: Double? = nil, avail: Bool? = nil, groupId: String? = nil, quantityFrom: Double? = nil, startTime: A2CDateTime? = nil, expireTime: A2CDateTime? = nil, additionalFields: JSONValue? = nil, customFields: JSONValue? = nil) {
        self.id = id
        self.value = value
        self.avail = avail
