...
public struct Basket: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(id: String? = nil, customer: BaseCustomer? = nil, basketUrl: String? = nil, createdAt: A2CDateTime? = nil, modifiedAt: A2CDateTime? = nil, currency: Currency? = nil, basketProducts: [BasketItem]? = nil, additionalFields: JSONValue? = nil, customFields: JSONValue? = nil) {
        self.id = id
