...
public struct ProductVariantAddBatch: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(clearCache: Bool? = false, reindex: Bool? = false, payload: [ProductVariantAddBatchPayloadInner], idempotencyKey: String? = nil) {
