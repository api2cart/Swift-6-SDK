...
public struct TaxClassCountries: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(id: String? = nil, name: String? = nil, code: String? = nil, tax: Double? = nil, taxType: Int? = nil, states: [TaxClassStates]? = nil, additionalFields: JSONValue? = nil, customFields: JSONValue? = nil) {
        self.id = id
        self.name = name
        self.code = code
        self.tax = tax
