...
public struct ProductOption: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(id: String? = nil, productOptionId: String? = nil, name: String? = nil, description: String? = nil, sortOrder: Int? = nil, type: String? = nil, _required: Bool? = nil, available: Bool? = nil, usedInCombination: Bool? = nil, optionItems: [ProductOptionItem]? = nil, additionalFields: JSONValue? = nil, customFields: JSONValue? = nil) {
        self.id = id
