...
public struct ProductInventory: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(warehouseId: String? = nil, quantity: Double? = nil, inStock: Bool? = nil, priority: Int? = nil, additionalFields: JSONValue? = nil, customFields: JSONValue? = nil) {
