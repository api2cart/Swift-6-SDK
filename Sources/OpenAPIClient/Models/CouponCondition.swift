...
public struct CouponCondition: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(id: String? = nil, entity: String? = nil, matchItems: String? = nil, key: String? = nil, _operator: String? = nil, value: String? = nil, logicOperator: String? = nil, subConditions: [CouponCondition]? = nil, additionalFields: JSONValue? = nil, customFields: JSONValue? = nil) {
        self.id = id
        self.entity = entity
