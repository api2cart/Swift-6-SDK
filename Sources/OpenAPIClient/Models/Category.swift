...
public struct Category: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(id: String? = nil, parentId: String? = nil, createdAt: A2CDateTime? = nil, modifiedAt: A2CDateTime? = nil, name: String? = nil, shortDescription: String? = nil, description: String? = nil, storesIds: [String]? = nil, keywords: String? = nil, metaDescription: String? = nil, metaTitle: String? = nil, avail: Bool? = nil, path: String? = nil, seoUrl: String? = nil, sortOrder: Int? = nil, images: [Image]? = nil, additionalFields: JSONValue? = nil, customFields: JSONValue? = nil) {
        self.id = id
