...
public struct OrderStatusRefund: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(shipping: Double? = nil, fee: Double? = nil, tax: Double? = nil, totalRefunded: Double? = nil, time: A2CDateTime? = nil, comment: String? = nil, refundedItems: [OrderStatusRefundItem]? = nil, additionalFields: JSONValue? = nil, customFields: JSONValue? = nil) {
