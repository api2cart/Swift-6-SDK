...
public struct BasketInfo200Response: Sendable, Codable, JSONEncodable, Hashable {

    public var returnCode: Int?
    public var returnMessage: String?
    public var result: Basket?

    public init(returnCode: Int? = nil, returnMessage: String? = nil, result: Basket? = nil) {
