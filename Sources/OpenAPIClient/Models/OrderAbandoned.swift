...
public struct OrderAbandoned: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(id: String? = nil, customer: BaseCustomer? = nil, basketId: String? = nil, basketUrl: String? = nil, createdAt: A2CDateTime? = nil, modifiedAt: A2CDateTime? = nil, currency: Currency? = nil, totals: OrderTotals? = nil, orderProducts: [OrderItem]? = nil, additionalFields: JSONValue? = nil, customFields: JSONValue? = nil) {
        self.id = id
