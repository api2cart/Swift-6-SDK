...
public struct ResponseOrderShipmentListResult: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(shipmentCount: Int? = nil, shipment: [Shipment]? = nil, additionalFields: JSONValue? = nil, customFields: JSONValue? = nil) {
