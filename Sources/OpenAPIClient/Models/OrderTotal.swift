...
public struct OrderTotal: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(subtotalExTax: Double? = nil, wrappingExTax: Double? = nil, shippingExTax: Double? = nil, totalDiscount: Double? = nil, totalTax: Double? = nil, total: Double? = nil, totalPaid: Double? = nil, additionalFields: JSONValue? = nil, customFields: JSONValue? = nil) {
