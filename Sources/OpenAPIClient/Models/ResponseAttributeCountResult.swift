...
public struct ResponseAttributeCountResult: Sendable, Codable, JSONEncodable, Hashable {

    public var attributesCount: Int?
    public var additionalFields: JSONValue?
    public var customFields: JSONValue?

    public init(attributesCount: Int? = nil, additionalFields: JSONValue? = nil, customFields: JSONValue? = nil) {
