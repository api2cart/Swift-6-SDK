...
public struct AnalyticsProductMetric: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(itemsSold: Int? = nil, ordersCount: Int? = nil, grossSales: Double? = nil, netSales: Double? = nil, discounts: Double? = nil, refunds: Double? = nil, currencyId: String? = nil, additionalFields: JSONValue? = nil, customFields: JSONValue? = nil) {
