...
public struct Info: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(owner: String? = nil, country: String? = nil, state: String? = nil, stateCode: String? = nil, city: String? = nil, streetAddress: String? = nil, streetAddressLine2: String? = nil, zipCode: String? = nil, email: String? = nil, phone: String? = nil, additionalFields: JSONValue? = nil, customFields: JSONValue? = nil) {
        self.owner = owner
