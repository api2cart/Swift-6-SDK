...
public struct ProductAddBatch: Sendable, Codable, JSONEncodable, Hashable {

    public enum NestedItemsUpdateBehaviour: String, Sendable, Codable, CaseIterable {
    ...
    public var payload: [ProductAddBatchPayloadInner]
    /** A unique identifier associated with a specific request. Repeated requests with the same <strong>idempotency_key</strong> return a cached response without re-executing the business logic. <strong>Please note that the cache lifetime is 15 minutes.</strong> */
    public var idempotencyKey: String?

    public init(nestedItemsUpdateBehaviour: NestedItemsUpdateBehaviour? = .replace, clearCache: Bool? = false, reindex: Bool? = false, payload: [ProductAddBatchPayloadInner], idempotencyKey: String? = nil) {
