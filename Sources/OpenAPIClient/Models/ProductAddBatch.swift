...
public struct ProductAddBatch: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(nestedItemsUpdateBehaviour: NestedItemsUpdateBehaviour? = .replace, clearCache: Bool? = false, reindex: Bool? = false, payload: [ProductAddBatchPayloadInner]) {
