...
public struct CartWarehouse: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(id: String? = nil, name: String? = nil, description: String? = nil, avail: Bool? = nil, address: CustomerAddress? = nil, carriersIds: [String]? = nil, storesIds: [String]? = nil, additionalFields: JSONValue? = nil, customFields: JSONValue? = nil) {
        self.id = id
        self.name = name
