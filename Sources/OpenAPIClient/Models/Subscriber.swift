...
public struct Subscriber: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(id: String? = nil, customerId: String? = nil, email: String? = nil, subscribed: Bool? = nil, firstName: String? = nil, lastName: String? = nil, storesIds: [String]? = nil, createdTime: String? = nil, modifiedTime: String? = nil, langId: String? = nil, gender: String? = nil, additionalFields: JSONValue? = nil, customFields: JSONValue? = nil) {
        self.id = id
