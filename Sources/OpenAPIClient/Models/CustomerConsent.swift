...
public struct CustomerConsent: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(id: String? = nil, type: String? = nil, status: String? = nil, source: String? = nil, optInLevel: String? = nil, modifiedTime: String? = nil, additionalFields: JSONValue? = nil, customFields: JSONValue? = nil) {
        self.id = id
        self.type = type
        self.status = status
        self.source = source
