//
// ModelResponseCustomerList.swift
//
...
public struct ModelResponseCustomerList: Sendable, Codable, JSONEncodable, Hashable {

    public var returnCode: Int?
    public var returnMessage: String?
    public var pagination: Pagination?
    public var result: ResponseCustomerListResult?
    public var additionalFields: JSONValue?
    public var customFields: JSONValue?

    public init(returnCode: Int? = nil, returnMessage: String? = nil, pagination: Pagination? = nil, result: ResponseCustomerListResult? = nil, additionalFields: JSONValue? = nil, customFields: JSONValue? = nil) {
