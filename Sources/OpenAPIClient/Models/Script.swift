...
public struct Script: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(id: String? = nil, name: String? = nil, description: String? = nil, src: String? = nil, scope: String? = nil, event: String? = nil, loadMethod: String? = nil, html: String? = nil, createdTime: A2CDateTime? = nil, modifiedTime: A2CDateTime? = nil, additionalFields: JSONValue? = nil, customFields: JSONValue? = nil) {
        self.id = id
        self.name = name
