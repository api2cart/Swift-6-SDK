...
public struct OrderItemOption: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(optionId: String? = nil, name: String? = nil, value: String? = nil, price: Double? = nil, weight: Double? = nil, type: String? = nil, productOptionValueId: String? = nil, additionalFields: JSONValue? = nil, customFields: JSONValue? = nil) {
