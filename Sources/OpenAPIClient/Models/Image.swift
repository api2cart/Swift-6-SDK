...
public struct Image: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(id: String? = nil, httpPath: String? = nil, fileName: String? = nil, mimeType: String? = nil, size: Int? = nil, createAt: A2CDateTime? = nil, modifiedAt: A2CDateTime? = nil, alt: String? = nil, avail: Bool? = nil, sortOrder: Int? = nil, type: String? = nil, additionalFields: JSONValue? = nil, customFields: JSONValue? = nil) {
        self.id = id
