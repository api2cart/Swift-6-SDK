...
public struct ReturnInfo200Response: Sendable, Codable, JSONEncodable, Hashable {

    public var returnCode: Int?
    public var returnMessage: String?
    public var result: Return?

    public init(returnCode: Int? = nil, returnMessage: String? = nil, result: Return? = nil) {
