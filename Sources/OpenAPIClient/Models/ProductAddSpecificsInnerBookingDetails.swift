...
public struct ProductAddSpecificsInnerBookingDetails: Sendable, Codable, JSONEncodable, Hashable {

    public enum ModelType: String, Sendable, Codable, CaseIterable {
        case date = "date"
        case dateTime = "date_time"
    }
    public enum TimeStrictType: String, Sendable, Codable, CaseIterable {
        case days = "days"
        case hours = "hours"
