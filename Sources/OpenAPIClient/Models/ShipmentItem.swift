...
public struct ShipmentItem: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(orderProductId: String? = nil, productId: String? = nil, variantId: String? = nil, model: String? = nil, name: String? = nil, price: Double? = nil, quantity: Double? = nil, additionalFields: JSONValue? = nil, customFields: JSONValue? = nil) {
