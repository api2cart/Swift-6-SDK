...
public struct ModelResponseTaxClassList: Sendable, Codable, JSONEncodable, Hashable {
    ...
    public init(returnCode: Int? = nil, returnMessage: String? = nil, pagination: Pagination? = nil, result: ResponseTaxClassListResult? = nil, additionalFields: JSONValue? = nil, customFields: JSONValue? = nil) {
