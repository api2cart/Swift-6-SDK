...
open class SubscriberAPI {
    ...
    open class func subscriberList(start: Int? = nil, count: Int? = nil, subscribed: Bool? = nil, storeId: String? = nil, email: String? = nil, params: String? = nil, exclude: String? = nil, createdFrom: String? = nil, createdTo: String? = nil, modifiedFrom: String? = nil, modifiedTo: String? = nil, pageCursor: String? = nil, responseFields: String? = nil, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) async throws(ErrorResponse) -> ModelResponseSubscriberList {
        return try await subscriberListWithRequestBuilder(start: start, count: count, subscribed: subscribed, storeId: storeId, email: email, params: params, exclude: exclude, createdFrom: createdFrom, createdTo: createdTo, modifiedFrom: modifiedFrom, modifiedTo: modifiedTo, pageCursor: pageCursor, responseFields: responseFields, apiConfiguration: apiConfiguration).execute().body
    }
     ...
     */
    open class func subscriberListWithRequestBuilder(start: Int? = nil, count: Int? = nil, subscribed: Bool? = nil, storeId: String? = nil, email: String? = nil, params: String? = nil, exclude: String? = nil, createdFrom: String? = nil, createdTo: String? = nil, modifiedFrom: String? = nil, modifiedTo: String? = nil, pageCursor: String? = nil, responseFields: String? = nil, apiConfiguration: OpenAPIClientAPIConfiguration = OpenAPIClientAPIConfiguration.shared) -> RequestBuilder<ModelResponseSubscriberList> {
